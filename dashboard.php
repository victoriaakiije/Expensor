...
<head>
	...
	<title>Expensor- Dashboard</title>
...
$sum_today_expense=$result['todaysexpense'];
 ?> 
						...
						<h4 style="color: #000000">Today's  Budget/Expense</h4>
...
$sum_yesterday_expense=$result1['yesterdayexpense'];
 ?> 
					<div class="panel-body easypiechart-panel">
						<h4 style="color: #000000">Yesterday's  Budget/Expense</h4>
...
$sum_weekly_expense=$result2['weeklyexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4 style="color: #000000">Last 7day's  Budget/Expense</h4>
...
$sum_monthly_expense=$result3['monthlyexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4 style="color: #000000">Last 30day's  Budget/Expense</h4>
...
$sum_yearly_expense=$result4['yearlyexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						<b><h4 style="color: #000000">Current Year  Budget/Expense</h4></b>
...
echo  "₦".number_format($sum_yearly_expense);
}
...
$sum_total_expense=$result5['totalexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4 style="color: #000000">Total  Budget/Expense</h4>
...
echo "₦".number_format($sum_total_expense);
}
